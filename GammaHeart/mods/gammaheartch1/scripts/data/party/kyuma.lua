...
function character:init()
    ...
    self.title = "A werewolf hero,\n ready to fight for\n the fate of a world."
    self.title_translations = {
        es = "Un héroe hombrelobo\nlisto para luchar por\n el destino del mundo.",
        ["pt-br"] = "Um herói lobisomem\npreparado para lutar pelo\n destino do mundo.",
        ja = "狼人間なヒーロー\n世界の運命をﾌｧｲﾄす\nるのをｲｵ決する。",
        LOLCAT = "KEWL WERWOLV HEROE\nRAEDY TO FAIT FOR\n THE FAET OF A WOLD!1"
    }
    ...
    self.xact_name = ({en="Kyum-Action",es="Kyum-Acción",["pt-br"]="Kyum-Ação",ja="丘真ーアクション",LOLCAT="KYOOMAH-AKSHOEN"})[Mod.selected_language]
