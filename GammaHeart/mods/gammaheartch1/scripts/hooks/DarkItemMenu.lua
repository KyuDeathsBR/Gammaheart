...
function DarkItemMenu:draw()
    ...
    local headers = {{en="USE",["pt-br"]="USAR",es="USAR",ja="使う",LOLCAT="USE TIEM"}, {en="TOSS",["pt-br"]="DEIXAR",es="DEJAR",ja="投げる",LOLCAT="TOS IT"}, {en="KEY",["pt-br"]="CHAVE",es="LLAVE",ja="重要",LOLCAT="KEY ITUMZ"}}
    ...
    for i,name in ipairs(headers) do
        ...
        local x = 88 + ((i - 1) * 120)
        love.graphics.print(name[Mod.selected_language], x, -2)
    end
