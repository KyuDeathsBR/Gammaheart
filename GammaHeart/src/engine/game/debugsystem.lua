...
function DebugSystem:registerDefaults()
    ...
    self:registerOption("main", "Restart", "Go back to chapter selection without\n closing the application in case you\n fucked up everything.", function()
        -- Go to empty state
        Gamestate.switch({})
        -- Clear the mod
    ...
    self:registerOption("main", "Change Allies", "Enter the allies changing menu.", function ()
                            self:enterMenu("change_allies", 0)
                        end, in_game)
