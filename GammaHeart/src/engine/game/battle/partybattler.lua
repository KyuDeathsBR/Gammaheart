...
---
---@field chara         PartyMember|PartyAlly The PartyMember this battler uses
...
function PartyBattler:update()
    ...
    if self.chara:includes(PartyAlly) then
        if self.chara:getAmulet() then
            self.chara:getAmulet():onBattleUpdate(self)
        end
    else
