...
function Kristal.quickReload(mode)
    ...
    if (Game.world and Game.party and Game.party[1] and Game.party[1].actor) and (mode == "temp" or Game.world:getCharacter(Game.party[1].actor.id)) then
        save = Game:save({Game.world:getCharacter(Game.party[1].actor.id).x,Game.world:getCharacter(Game.party[1].actor.id).y})
...
function Kristal.loadMod(id, save_id, save_name, after)
    ...
    Mod = Mod or { info = mod, libs = {}, selected_language = Language or "en", mode = "LIGHT" }
